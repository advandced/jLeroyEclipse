...
public class ProductConfDaoImpl implements ProductConfDao {
    ...
    public void updateProductConf(ProductConf productConf, String reference,
        ...
        System.out.println("FollowingFormModel : " + followingFormModel.toString());
        int _idProductSupply = 0;
        if (null != productSupply) {
            _idProductSupply = productSupply.getIdProductSupply();
        } else {
        ...
        System.out.println("KNOCK MOTHAFUCKA 3");
    }
    ...
    public List<ProductConf> getProductConfLazy(Map<String, String> filters, int limit, int maxperpage)
        ...
        String rqt = "SELECT * FROM productconf pc, productfamily pf, productsupply ps WHERE pc.idProductSupply = ps.idProductSupply AND pc.idProductFamily = pf.idProductFamily ";
    ...
    public int countProductConf(Map<String, String> filters) throws SQLException {
        ...
        ResultSet _rs = null;
        int count = 0;
        String rqt = "SELECT count(*) FROM productconf pc, productfamily pf, productsupply ps WHERE pc.idProductSupply = ps.idProductSupply AND pc.idProductFamily = pf.idProductFamily ";
        if (filters.containsKey("minorIndex") == true) {
            rqt += "AND pc.minorIndex LIKE '%" + filters.get("minorIndex") + "%' ";
        }
        if (filters.containsKey("majorIndex") == true) {
