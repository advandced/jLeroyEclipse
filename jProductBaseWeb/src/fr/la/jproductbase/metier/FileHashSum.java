 ...
 * 
 * @author Mr-Hide (JB, http://www.mrhide.fr) copyleft
 */
public class FileHashSum {
	/**
	 * compare le <code>sha1sum</code> donné avec l'empreinte du fichier local
	 * <code>file</code>.
	 * 
	 * @param file
	 *            le fichier dont on doit calculer l'empreinte sha1
	 * @param sha1sum
	 *            l'empreinte à comparer
	...
	/**
	 * Compare le <code>md5sum</code> donné avec l'empreinte du fichier local
	 * <code>file</code>. L'utilisation de MD5 est déconseillée ! Il existe en
	 * effet une faille de sécurité par collision sur MD5 Utilisez plutôt SHA-1.
	 * 
	 * @param file
	 *            le fichier dont on doit calculer l'empreinte md5
	 * @param sha1sum
	 *            l'empreinte à comparer
