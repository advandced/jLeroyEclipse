...
public class UserRightSession implements Serializable {
    ...
    public UserRightSession() throws SQLException {
        ...
        Ressource _resourceOp = new Ressource(2, "/param/operator.xhtml?faces-redirect=true",
                "Operateur", "gestOperatorBean",
                "ressource pour gestion operateur", _resource);
        Ressource _resourceLog = new Ressource(3, "/param/software.xhtml?faces-redirect=true",
                "Logiciels", "gestOperatorBean",
                "ressource pour gestion logiciel", _resource);
        Ressource _resourceAppCause = new Ressource(4,
                "/param/apparentCause.xhtml?faces-redirect=true", "Causes Probables",
                "gestApparentCauseBean",
                "ressource pour gestion apparent cause", _resource);
        Ressource _resourceAppCustomerCause = new Ressource(5,
                "/param/apparentCauseCustomer.xhtml?faces-redirect=true", "Cause Probables Client",
                "gestApparentCauseCustomerBean",
                "ressource pour gestion apparent cause client", _resource);
        Ressource _resourceTester = new Ressource(6, "/param/tester.xhtml?faces-redirect=true",
                "Tester", "gestTesterBean", "ressource pour gestion Tester",
                _resource);
        Ressource _resourceTypeTest = new Ressource(7, "/param/typeTest.xhtml?faces-redirect=true",
                "Types de Test", "gestTypeTestBean",
                "ressource pour gestion Type Test", _resource);
        Ressource _resourceConfProd = new Ressource(8,
                "/param/productConf.xhtml?faces-redirect=true", "Configuration des produits",
                "gestProductConfBean",
                "ressource pour Configuration des Produits", _resource);
        Ressource _resourceProdFamily = new Ressource(9,
                "/param/productFamily.xhtml?faces-redirect=true", "Familles de produits",
                "gestProductFamilyBean",
                "ressource pour Configuration des Familles de Produit",
                _resource);
        Ressource _resourceProdType = new Ressource(10,
                "/param/productType.xhtml?faces-redirect=true", "Types de Produits",
                "gestProductTypeBean",
                "ressource pour Configuration des types de produits", _resource);
        Ressource _resourcePodSupply = new Ressource(11,
                "/param/productSupply.xhtml?faces-redirect=true", "Alimentations",
                "gestProductSupplyBean",
        ...
        Ressource _resourceSearchProd = new Ressource(13,
                "/entryPROD/searchProducts.jsf?faces-redirect=true", "Rechercher Produits",
                "GestSearchProductsBean", "rechercher un produit",
                _resourceSaiseProd);
        Ressource _resourceSearchCards = new Ressource(14,
                "/entryPROD/searchCards.jsf?faces-redirect=true", "Rechercher Cartes",
                "GestSearchCardsBean", "rechercher une Carte",
                _resourceSaiseProd);
        Ressource _resourceSaveProd = new Ressource(15,
                "/entryPROD/saveProduct.jsf?faces-redirect=true", "Enregistrement",
                "GestSaveProdBean", "Enregistrement Produit",
                _resourceSaiseProd);
        Ressource _resourceDefaultRapp = new Ressource(16,
                "/entryPROD/entryDefaultRapport.jsf?faces-redirect=true", "Saisie Rapport Defaut",
                "GestDefaultRapportBean", "Enregistrement Defaut",
                _resourceSaiseProd);
        Ressource _ressourceSearchByDate = new Ressource(25,
                "/entryPROD/cailloux.jsf?faces-redirect=true", "Recherche Date Reparation",
                "CaillouxBean", "Recherche par Date de Reparation",
                _resourceSaiseProd);
        ...
        Ressource _resourceEntryIntervention = new Ressource(18,
                "/entrySAV/entryIntervention.jsf?faces-redirect=true", "Saisir Intervention",
                "GestEntryInterventionBean", "Enregistrement Intervention",
                _resourceEntrySAV);
        Ressource _ressourceRecapCom = new Ressource(19,
                "/entrySAV/recapCom.jsf?faces-redirect=true", "Recap Commerce", "recapCOMBean",
                "Recapitulatif de la partie Commerce", _resourceEntrySAV);
        Ressource _ressourceExpedSav = new Ressource(20,
                "/entrySAV/expedSAV.jsf?faces-redirect=true", "Expedition SAV", "expedSAVBean",
                "Gestion des expeditions du SAV", _resourceEntrySAV);
        Ressource _ressourceNumCmd = new Ressource(21,
                "/entrySAV/numCommande.jsf?faces-redirect=true", "Numero de Commande",
                "NumCommandeBean", "Attribution du numéro de commande",
                _resourceEntrySAV);
        Ressource _ressourceValidControl = new Ressource(22,
                "/entrySAV/validControl.jsf?faces-redirect=true", "Controle Qualite",
                "ValidControlBean",
                "Attribution d'une date de Controle Qualite", _resourceEntrySAV);
        Ressource _ressourceDevisPrealable = new Ressource(23,
                "/entrySAV/devisPrealable.jsf?faces-redirect=true", "Devis Prealable",
                "DevisPrealableBean", "", _resourceEntrySAV);
        Ressource _ressourceDevisRepa = new Ressource(24,
                "/entrySAV/devisReparation.jsf?faces-redirect=true", "Devis Reparation",
                "DevisRepaBean", "", _resourceEntrySAV);
        Ressource _ressourceFollowing = new Ressource(25,
                "/param/followingForm.jsf?faces-redirect=true", "Following Form",
                "FollowingFormBean", _resource);
        Ressource _ressourceProductConfModel = new Ressource(26,
                "/param/productConfModel.jsf?faces-redirect=true", "Product Conf Model",
                "ProductConfModelBean", _resource);
        ...
        Autorisation _autorisationProductConfModel = new Autorisation(_permission,
                _ressourceProductConfModel, _role);
